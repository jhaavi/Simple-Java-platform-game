...
/**
 * this is the declaration of the public Background3 class. this class provides the background
...
public class Background3 extends StaticBody {
     ...
     */
    public static BodyImage image = new BodyImage("data/background3.gif", 40);
    
    /**
     *
     * @param world
     */
    public Background3(World world) {
