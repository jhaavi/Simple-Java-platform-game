 ...
 */
public class GameWorld3 extends GameLevel {
    ...
    public void populate(Game game) {
        ...
        { // make platforms
            ...
            platform5.setPosition(new Vec2(19,-5));
...
//        }
        ...
        
        {
            ...
            death3.setPosition(new Vec2(-25, -5));
            death3.addCollisionListener(new LiveDown(getPlayer()));
            
            Body death4 = new Boss(this);
            death4.setPosition(new Vec2(0,-4));
            death4.addCollisionListener(new InstantDeath(getPlayer()));
...
//            instruction.setPosition(new Vec2(-20,10));
        ...
        
        {
            ...
            background = new Background3(this);
