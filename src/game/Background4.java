...
/**
 * this is the declaration of the public Background4 class. this class provides the background
...
public class Background4 extends StaticBody {
     ...
     */
    public static BodyImage image = new BodyImage("data/background4.gif", 40);
    
    /**
     *
     * @param world
     */
    public Background4(World world) {
